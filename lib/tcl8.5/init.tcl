...
#
# ActiveState ActiveTcl 8.5.18.0.298892 Win32/x64, Wed Mar 11 22:38:39 PDT 2015
#
...
namespace eval ::activestate {
	...
	product       {ActiveTcl}
	release       {8.5.18.0}
	tcl,revision  {d6acbd85345d03232659a62e6b147a1ce000cb5d}
	tk,revision   {b1f60f3e6ef9ff45449b421ccddb0adfd8bdb3ff}
	maturity      {final}
	arch          {win32-x64}
	buildtime,sec {1426138719}
	buildtime,fmt {Wed Mar 11 22:38:39 PDT 2015}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.18.0.298892 Win32/x64 @ Wed Mar 11 22:38:39 PDT 2015 d6acbd85345d03232659a62e6b147a1ce000cb5d / normal}
    }
}

package provide {ActiveTcl} {8.5.18.0.298892}
