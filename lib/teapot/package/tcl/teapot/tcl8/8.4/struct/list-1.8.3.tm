...
# Meta subject         reduce permutation {longest common subsequence}
# Meta subject         common {left outer join} comparison reverse list
# Meta subject         {right outer join} differential map flatten join
# Meta subject         equal {first permutation} swapping diff
# Meta subject         {full outer join} subsequence repetition folding
# Meta subject         reshuffle {inner join} Fisher-Yates shuffle assign
# Meta subject         {generate permutations} equality filter repeating
# Meta subject         {outer join} {next permutation}
