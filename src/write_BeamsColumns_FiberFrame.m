function [EL_ELEMENTS] = write_BeamsColumns_FiberFrame (INP, NStory, NBay, ColElementOption, MF_COLUMNS, MF_BEAMS, nIntegration)
...
for Story=NStory:-1:1
    ...
    for Axis=1:NBay+1
        ...
        elseif ColElementOption==2
            secID=secID+1;
            matID=matID+1;
            fprintf(INP,'FiberRC_Rectangular %5d %.4f %.4f %.4f %.4f %2d %.4f %2d %.4f  %2d %.4f; ',secID,SecData.H,SecData.B,SecData.coverH,SecData.coverB,SecData.nBarTop,SecData.areaBarTop,SecData.nBarBot,SecData.areaBarBot,SecData.nBarsInt,SecData.areaBarInt); 
