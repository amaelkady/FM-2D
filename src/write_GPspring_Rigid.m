function write_GPspring_Rigid (INP)

global MainDirectory
load(strcat(MainDirectory,'\temp_unpacked'),'FrameType','BraceLayout','NStory','NBay');

fprintf(INP,'####################################################################################################\n');
fprintf(INP,'#                                 			GUSSET PLATE RIGID SPRINGS   		                            #\n');
fprintf(INP,'####################################################################################################\n');
fprintf(INP,'\n');
    ...
    for Floor=NStory+1:-1:2
        ...
        if mod(Floor,2)==0 || BraceLayout==2
            for Bay=1:NBay
                ...
                fprintf(INP,'Spring_Rigid %d %6d %6d;\n', SpringID33, nodeID13, nodeID3);
                matID=matID+1;
                fprintf(INP,'Spring_Rigid %d %6d %6d;\n', SpringID44, nodeID14, nodeID4);
                matID=matID+1;
                if Floor<NStory+1 && FrameType==2 && BraceLayout==1
                    ...
                    fprintf(INP,'Spring_Rigid %d %6d %6d;\n', SpringID66, nodeID16, nodeID6);
                    matID=matID+1;
                    fprintf(INP,'Spring_Rigid %d %6d %6d;\n', SpringID77, nodeID17, nodeID7);
                    matID=matID+1;
                end
            end
            fprintf(INP,'\n');
