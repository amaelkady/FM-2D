function write_BeamSpring_CBF (INP, NStory, NBay, WBay, BraceLayout, MF_COLUMNS, MF_BEAMS, MGP_W, MFconnectionOdd, MFconnectionEven, fy, Units)
...
for Floor=NStory+1:-1:2
    ...
    if mod(Floor,2)==0 || BraceLayout==2
        ...
        for Bay=1:NBay
            ...
            iNode = 200000+1000*Floor+100*Bay+2;
            jNode = 200000+1000*Floor+100*Bay+12;
