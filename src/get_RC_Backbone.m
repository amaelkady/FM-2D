...
function [My]=get_RC_Backbone(fc,Ec,fy,Es,b,h,d1,s,area_T,area_C,area_I,area_SH,PPc, a_sl, Units)
...
theta_p  	= 0.13*(1+0.55*a_sl) 	* 0.130^PPc * (0.02+40*rho_SH)^0.65 * 0.57^(0.01*c_unit*fc);
theta_pc 	= 0.76 			    	* 0.031^PPc * (0.02+40*rho_SH)^1.02; if theta_pc  > 0.10; theta_pc= 0.1; end
theta_p_tot = 0.14*(1+0.40*a_sl) 	* 0.190^PPc * (0.02+40*rho_SH)^0.54 * 0.62^(0.01*c_unit*fc);
