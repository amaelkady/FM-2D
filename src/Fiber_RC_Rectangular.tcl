######################################################################################################################
# Fiber_RC_Rectangular $secTag $H $B $coverH $coverB $nBarTop $areaBarTop $nBarBot $areaBarBot $nBarIntTot $areaBarInt
######################################################################################################################
#
...
proc Fiber_RC_Rectangular {secID H B coverH coverB nBarTop areaBarTop nBarBot areaBarBot nBarIntTot areaBarInt} {
