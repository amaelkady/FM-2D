function Import_ExcelData_EBF(ExcelFilePath,ExcelFileName, NStory, NBay,FloorLink)
...
[num,txt,Data] = xlsread(ExcelFileName,'MF SL','B2:U50');
...
[num,txt,Data] = xlsread(ExcelFileName,'EBF W','B2:U50');
EBF_W=num(1:NStory,1:NBay);
...
cd (ProjectPath)
save(ProjectName,'ExcelFileName','ExcelFilePath','HStory', 'WBay', 'MF_COLUMNS','MF_BEAMS','GF_COLUMNS','GF_BEAMS','Doubler','Splice','WBuilding','HBuilding','CGP_tp','MGP_tp','BRACES', 'CGP_L123', 'MGP_L123', 'MGP_W','MGP_RigidOffset','CGP_RigidOffset','MGP_Lc','CGP_Lc','Brace_L','Fs_Profile','MF_SL','EBF_W','-append')
cd (MainDirectory)