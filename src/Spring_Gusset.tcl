...
# Spring_Gusset.tcl
#
# SubRoutine to construct an out-of-plane rotational spring with a bilinear repsonse for the gusset plate.
#
# References: 
#--------------	
...
element zeroLength $SpringID $NodeI $NodeJ  -mat 99 99 99 $matTag 99 99 -dir 1 2 3 4 5 6 -doRayleigh 1;;
