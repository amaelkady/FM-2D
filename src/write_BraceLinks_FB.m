function write_BraceLinks_FB (INP, NStory, NBay, FrameType, BraceLayout,PZ_Multiplier, BRACES, CGP_tp, CGP_Lc, MGP_tp, MGP_Lc, Units)
    ...
    for Floor=NStory+1:-1:2
        ...
        if mod(Floor,2)==0 || BraceLayout==2
            for Bay=1:NBay
                ...
                fprintf(INP,'Spring_Gusset_FB %d %d %d $E $fyG  %.4f  %.4f  %.4f;\n',ElemID33, nodeID1, nodeID3, MGP_tp(Storyj,Bay), mean(MGP_Lc(Storyi,1)), SecData.h(idxi));
                %fprintf(INP,'element elasticBeamColumn %d %d %d $A_Stiff $E $I_Stiff  $trans_Corot;\n',   ElemID44, nodeID1,nodeID4);
                fprintf(INP,'Spring_Gusset_FB %d %d %d $E $fyG  %.4f  %.4f  %.4f;\n',ElemID44, nodeID1, nodeID4, MGP_tp(Storyj,Bay), mean(MGP_Lc(Storyi,1)), SecData.h(idxi));
                ...
                if Floor<NStory+1 && BraceLayout==1
                    ...
                    fprintf(INP,'Spring_Gusset_FB %d %d %d $E $fyG  %.4f  %.4f  %.4f;\n',ElemID66, nodeID1, nodeID6, MGP_tp(Storyj,Bay), mean(MGP_Lc(Storyi,1)), SecData.h(idxi));
                    fprintf(INP,'Spring_Gusset_FB %d %d %d $E $fyG  %.4f  %.4f  %.4f;\n',ElemID77, nodeID1, nodeID7, MGP_tp(Storyj,Bay), mean(MGP_Lc(Storyi,1)), SecData.h(idxi));
            ...
            if mod(Floor,2)~=0 || BraceLayout==2
                for Axis=1:NBay+1
                    ...
                    if Floor~=1 && Floor~=NStory+1
                        ...
                        fprintf(INP,'Spring_Gusset_FB %d %d %d $E $fyG  %.4f  %.4f  %.4f;\n',ElemID11, nodeID1, nodeID2, CGP_tp(Storyj,Bay), mean(CGP_Lc(Storyi,1)), SecData.h(idxi));
                        ...
                        if BraceLayout==1
                            ...
                            fprintf(INP,'Spring_Gusset_FB %d %d %d $E $fyG  %.4f  %.4f  %.4f;\n',ElemID99, nodeID1, nodeID2, CGP_tp(Storyj,Bay), mean(CGP_Lc(Storyi,1)), SecData.h(idxi));
                        end
        ...
        for Floor=NStory+1:-1:1
            ...
            if mod(Floor,2)~=0 || BraceLayout==2
                for Axis=1:NBay+1
                    ...
                    elseif Floor==NStory+1 && mod(Floor,2)~=0 && BraceLayout==1
