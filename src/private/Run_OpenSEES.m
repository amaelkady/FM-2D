        ...
        for Ri = 1 : nRealizations
            ...
            while SAcurrent < 10.0                                                                                  % Run as long as Collapse is not reached (Arbitrary High Value Since Algorithm Stops at Collapse)
                ...
                if Dynamic_TargetSF==1
                    SFcurrent=SF;
                    SAcurrent=SFcurrent*GM.sa{:,GM_No};
                elseif Dynamic_TargetSA==1
                    SFcurrent=TargetSA/GM.sa{:,GM_No};                                                                 % Calculate Current Scale Factor for Current SA
                else
                    SFcurrent=SAcurrent/GM.sa{:,GM_No};                                                                 % Calculate Current Scale Factor for Current SA
                end
