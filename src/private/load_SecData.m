...
if ~contains(Section, 'BU')==0
    ...
    elseif ~contains(Section, 'IP')==0 || ~contains(Section, 'HE')==0 || ~contains(Section, 'HD')==0 || ~contains(Section, 'UB')==0 || ~contains(Section, 'UC')==0
