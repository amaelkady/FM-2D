function CREATOR_MODEL_EGF (AnalysisTypeID,TempPOrun)
...
write_Nodes_EGF (INP, NStory, NBay, FrameType, BraceLayout, MF_COLUMNS, MF_BEAMS, MGP_W, EBF_W, Splice, HStory, Units);

write_SpliceSpring_EGF (INP, NStory, NBay, Splice, SpliceConnection);
...
write_BCs_EGF (INP,FrameType,NStory,NBay,PZ_Multiplier,RigidFloor,Support, SupportGFS,MidSpanConstraint,BraceLayout);

write_Recorders_EGF(INP, NStory, NBay, Recorders, Filename, FrameType, BraceLayout, Splice, FloorLink, AnalysisTypeID, GFX, Orientation);

write_Mass_EGF(INP, EL_ELEMENTS);